...
ln -sf /secrets/ssl/fleming-dev.dsc.umich.edu.cert /etc/ssl/certs/fleming-dev.dsc.umich.edu.cert
ln -sf /secrets/ssl/fleming-dev.dsc.umich.edu.key /etc/ssl/private/fleming-dev.dsc.umich.edu.key
