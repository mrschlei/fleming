...
function bootstrap_flem_bootstrap_search_form_wrapper($variables) {
...
function bootstrap_flem_form_alter(&$form, &$form_state, $form_id) {
...
function bootstrap_flem_webform_element($variables) {
  // Ensure defaults.
...
function bootstrap_flem_preprocess_breadcrumb(&$variables) {
